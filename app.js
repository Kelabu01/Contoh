...
const languageCopy = {
  en: {
    ...
    values: {
      ...
      '#locations .eyebrow': 'Come say hello', '#locations-title': 'Find your Pociato Coffee & Pizza', '#locations .section-heading > p': 'Choose the Pociato Coffee & Pizza location closest to you and get directions in a tap.', '.location-link': 'Get directions <span aria-hidden="true">↗</span>',
      '#connect .eyebrow': 'Stay in the loop', '#connect-title': 'Follow along with Pociato Coffee & Pizza.', '#connect .contact-copy > p:last-child': 'Find new dishes, pizza moments, location updates and more on our social channels.', '.connect-card .primary': 'Follow on Instagram', '.connect-card .secondary:nth-of-type(2)': 'Follow on TikTok', '.connect-card .secondary:nth-of-type(3)': 'All Pociato Coffee & Pizza links', '.footer-grid > div:first-child > p': 'Coffee, pizza, and good company across Selangor and Cyberjaya.', '.footer-links a[href="#locations"]': 'Locations', '.footer-links a[href="#connect"]': 'Connect', '.footer-bottom span:last-child': 'Menu and hours coming soon', '.whatsapp span:last-child': 'Contact'
    }
  },
  ms: {
    ...
    values: {
      ...
      '#locations .eyebrow': 'Mari berkunjung', '#locations-title': 'Cari Pociato Coffee & Pizza anda', '#locations .section-heading > p': 'Pilih lokasi Pociato Coffee & Pizza yang paling dekat dengan anda dan dapatkan arah dengan satu sentuhan.', '.location-link': 'Dapatkan arah <span aria-hidden="true">↗</span>',
      '#connect .eyebrow': 'Ikuti perkembangan', '#connect-title': 'Ikuti Pociato Coffee & Pizza.', '#connect .contact-copy > p:last-child': 'Dapatkan info hidangan baharu, momen piza, kemas kini lokasi dan banyak lagi di saluran sosial kami.', '.connect-card .primary': 'Ikuti di Instagram', '.connect-card .secondary:nth-of-type(2)': 'Ikuti di TikTok', '.connect-card .secondary:nth-of-type(3)': 'Semua pautan Pociato Coffee & Pizza', '.footer-grid > div:first-child > p': 'Kopi, piza dan teman baik di seluruh Selangor dan Cyberjaya.', '.footer-links a[href="#locations"]': 'Lokasi', '.footer-links a[href="#connect"]': 'Hubungi', '.footer-bottom span:last-child': 'Menu dan waktu operasi akan datang', '.whatsapp span:last-child': 'Hubungi'
    }
  }
};
...
const sections = [...document.querySelectorAll('#home, #menu, #locations, #connect')];
